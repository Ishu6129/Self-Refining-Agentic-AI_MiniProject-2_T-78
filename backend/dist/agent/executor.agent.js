...
const toolHandle_1 = require("../controllers/toolHandle");
...
async function executorAgent(plan, apiKey) {
    ...
    try {
        while (iterations < MAX_ITERATIONS) {
            const response = await (0, base_agent_1.chatWithMessages)(messages, 0.1, apiKey);
            ...
            if (toolCallMatch) {
                ...
                try {
                    const toolResult = await (0, toolHandle_1.handleToolAction)({ type: toolName, input: query });
